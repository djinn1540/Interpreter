...
;(add-bindiing (caddr get-value (cadr statement)) (caddr statement (push-frame environment)) sets up the function by passing the actual parameters to formal and creating a function scope
...
(define newframe
  (lambda ()
    '(() () () ()))) ; the format is ( (variable names) (variable values) (function names) (function-info) ) where a function-info is ( (function parameter names) (the function body statement list) ) 
